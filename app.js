...
const updatePage = async () => {
  ...
  const filteredArray = fruitsArray.filter(fruit => fruit.nutritions.sugar > 10);
  const filtermap = filteredArray.map(fruit => fruit.name).join(",");
